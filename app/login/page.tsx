      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-[#05050A] px-6 py-12 lg:px-16">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-xs text-[#64748B]">o continúa con</span>
            <div className="flex-1 h-px bg-slate-900" />
          </div>
          ...
          <button
            ...
            className="mb-8 flex w-full items-center justify-center gap-3 rounded-xl bg-[#0F0F1A] border border-[#1a1a2e] hover:bg-[#181829] py-3 text-sm font-medium text-[#F8FAFC] transition-colors"
          >
