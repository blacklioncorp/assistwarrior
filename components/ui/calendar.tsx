    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-[#EEF4FF] hover:text-[#1E4A8A]"
        ),
        range_end: "day-range-end",
        selected:
          "bg-[#1E4A8A] text-white hover:bg-[#1a3f78] hover:text-white focus:bg-[#1E4A8A] focus:text-white",
        today: "bg-slate-100 text-slate-900",
        outside:
          "day-outside text-slate-400 aria-selected:bg-slate-100/50 aria-selected:text-slate-500",
